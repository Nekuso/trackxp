    ...
    <StyledStack>
      ...
      >
        ...
        <div className="stack__images">
          ...
          >
            <img loading="lazy" src={ReactLogo} alt="" />
          </motion.div>
          <motion.div
            variants={container}
            whileTap={{ scale: 0.8 }}
            ...
            className="stack__image"
          >
            <img loading="lazy" src={NodeLogo} alt="" />
          </motion.div>
          <motion.div
            variants={container}
            whileTap={{ scale: 0.8 }}
            ...
            className="stack__image"
          >
            <img loading="lazy" src={FramerLogo} alt="" />
          </motion.div>
          <motion.div
            variants={container}
            whileTap={{ scale: 0.8 }}
            ...
            className="stack__image"
          >
            <img loading="lazy" src={FireBaseLogo} alt="" />
          </motion.div>
          <motion.div
            variants={container}
            whileTap={{ scale: 0.8 }}
            ...
            className="stack__image"
          >
            <img loading="lazy" src={StyledLogo} alt="" />
          </motion.div>
        </div>
      </motion.div>
    </StyledStack>
